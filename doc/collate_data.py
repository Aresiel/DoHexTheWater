...
# TO USE:
# python doc/collate_data.py /DoHexTheWater/Common/src/main/resources /DoHexTheWater/doc/HexCastingResources dohexthewater dohexthewaterbook doc/template.html doc/out.html
...
pattern_stubs = [(None, "dev/aresiel/dohexthewater/common/casting/RegisterPatterns.java")]
